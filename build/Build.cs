...
#pragma warning restore IDE0051 // Удалите неиспользуемые закрытые члены
    ...
    internal Target Generate => _ => _
    .Executes(() =>
    {
        CSharpSchemaGenerate.Generate(RootDirectory / "schema" / "pg-spell.json", s => s
            .SetFileName("PgSpell")
            .SetNamespace("Steelax.PgSpell.Schema")
            .SetDirectory(SourceDirectory / "Steelax.PgSpell" / "Schema"))
